...
public class S_apply {
	...
	private void initialize() {
		...
		button_apply.setOnAction(event -> {
			...
			apply.setYearSubId(recruit_oneYear.getSelectionModel().getSelectedItem().toString());
			apply.setYearMeal(meal_oneYear.getSelectionModel().getSelectedItem().toString());
