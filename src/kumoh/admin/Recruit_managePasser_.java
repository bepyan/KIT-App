...
public class Recruit_managePasser_ {
	...
	private void initialize() {
		...
		autoVaild.setOnAction(e ->{
			App.pop(App.apath + "popUp.fxml");
			new FadeIn(App.root).setSpeed(1.1).play();
			makeTable();
		});
